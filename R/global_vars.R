globalVariables(c(
  "..doc_index_chunk_dl", "CIK", "Company Name", "Date Filed", "Filename",
  "Form Type", "abbrevs_adjusted", "bind_cols", "com_cik", "doc_an",
  "doc_form_type", "key_value_raw", "median", "pattern", "replacement",
